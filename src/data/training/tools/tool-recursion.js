...
`def count_down(n):
    ...
    return count_down(n - 1)`,
      'count_down(2)',
      [
        { line: 2, state: { n: 2 }, ask: 'n', note: 'One frame open, holding the parcel it was handed. Line 2 asks whether this is the last envelope and it is not, so line 4 will ask somebody else.' },
        { line: 2, state: { n: 1 }, ask: 'n', note: 'A second frame with its own n, and a smaller parcel. The first frame is still open, parked on line 4, waiting for an answer it cannot work out itself.' },
        { line: 3, state: { n: 0, returns: 'done' }, ask: 'returns', note: 'Three frames stacked now, and only this one answers without asking anybody. That is the base case, and it is the only reason the stack ever shrinks.' },
        { line: 4, state: { n: 2, returns: 'done' }, ask: 'returns', note: '“done” came back up through the n = 1 frame and then through this one, the first frame opened and the last to close. Three frames in, three frames out, and none of them ever saw another frame’s n.' },
      ]),
